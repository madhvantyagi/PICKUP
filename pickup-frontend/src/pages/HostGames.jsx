  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        ...
        const { latitude, longitude } = await getGeocode(
                ...
                {SPORTS.map((sport) => (
                  <button
                    ...
                    className={`sport-button ${
                      formData.sport === sport.id ? "selected" : ""
                    }`}
                  >
                ...
                <div className="toggle-group">
                  <button
                    ...
                    className={`toggle-button ${
                      formData.location.locationType === "indoor"
                        ? "active"
                        : ""
                    }`}
                    onClick={() =>
                  ...
                  <button
                    type="button"
                    className={`toggle-button ${
                      formData.location.locationType === "outdoor"
                        ? "active"
                        : ""
                    }`}
                    onClick={() =>
              ...
              <div className="checkbox-group">
                <label>
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, autoJoin: e.target.checked })
                    }
                  />
